...
class UsersAdministrationViewScientistMobile extends StatefulWidget {
  UsersAdministrationViewScientistMobile({Key key}) : super(key: key);

  @override
  _UsersAdministrationViewScientistMobileState createState() =>
      _UsersAdministrationViewScientistMobileState();
}

class _UsersAdministrationViewScientistMobileState
    extends State<UsersAdministrationViewScientistMobile> {
                                  ...
                                  if (selectedRow.length == 1)
                                    {
                                      ...
                                      await authproviderInstance.updateUserStatus(
                                          uid,
