...
class UsersAdministrationViewAdminTablet extends StatefulWidget {
  UsersAdministrationViewAdminTablet({Key? key}) : super(key: key);

  @override
  _UsersAdministrationViewAdminTabletState createState() =>
      _UsersAdministrationViewAdminTabletState();
}

class _UsersAdministrationViewAdminTabletState
    extends State<UsersAdministrationViewAdminTablet> {
