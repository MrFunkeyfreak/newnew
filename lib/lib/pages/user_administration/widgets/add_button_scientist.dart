                                        ...
                                        if (mapUserinformations!.isNotEmpty) {
                                          ...
                                          if (mapUserinformations!['status'] ==
                                            ...
                                            try {
                                              ...
                                              mapUsernameExist = await authproviderInstance.UsernameExist(usernameController.text.trim());                                         //if username already exist, then print error otherwise it is free
